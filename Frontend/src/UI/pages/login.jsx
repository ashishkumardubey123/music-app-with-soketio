...
export default function LoginPage() {
      ...
      return (
            /*
             * Page wrapper
             * bg uses arbitrary gradient + custom animation-gradient-shift
             * [background-size:400%_400%] enables the slow-pan effect
             */
            <div
                  className="
      ...
      "
        ...
        "
                  ...
                  {/* Card glow – centred halo behind the glass card */ }
                  <div
                        className="
          pointer-events-none absolute left-1/2 top-1/2
          h-[480px] w-[480px] -translate-x-1/2 -translate-y-1/2 rounded-full
          bg-[radial-gradient(circle,rgba(124,58,237,0.18)_0%,transparent_65%)]
        ...
        "
                  ...
                  <div
                        className="
          relative z-10 w-full max-w-[440px] rounded-3xl
          border border-white/[0.11]
          bg-white/[0.06] px-10 pb-9 pt-11
        ...
        "
              ...
              "
                        ...
                        <div className="mb-3.5 animate-fade-up">
                              <div className="relative">
                                    <span className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-[#958da1]/70 flex items-center">
                                          <EmailIcon />
                                    </span>
                                    <input
                                          type="email"
              ...
              "
                        ...
                        {/* ── Password Input ── */ }
                        <div className="mb-2.5 animate-fade-up-delay">
                              <div className="relative">
                                    <span className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-[#958da1]/70 flex items-center">
                                          <LockIcon />
                                    </span>
              ...
              "
                        ...
                        <div className="mb-6 flex justify-end">
                              <a
                                    href="#"
                                    className="
              text-[13px] font-medium text-[#d2bbff]/70
            ...
            "
                        ...
                        <button
                              type="button"
                              className="
            mb-7 w-full cursor-pointer rounded-full border-none
